/**
 * Serviço de calculadora com Angular
...
//@Injectable faz a classe entender que é um serviço
@Injectable()
export class CalculadoraService {
  ...
  /**
   * Metodo  que calcula uma operacao matemática  dado dois números 
   * Suporta as operações soma, subtração, divisão e multiplicação
   * @param num1 number
   * @param num2 number
   * @param operacao operacao string Operacao a ser executada 
